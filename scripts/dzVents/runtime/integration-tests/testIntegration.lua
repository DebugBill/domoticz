...
local DUMMY_HW = 15
<<<<<<< HEAD:scripts/dzVents/runtime/integration-tests/testIntegration.lua
local SECPANEL_INDEX = 42
=======

>>>>>>> 98723b7da9467a49222b8a7ffaae276c5bc075c1:dzVents/runtime/integration-tests/testIntegration.lua
local SWITCH_TYPES = {
	BLINDS = 3,
	BLINDS_INVERTED= 6,
